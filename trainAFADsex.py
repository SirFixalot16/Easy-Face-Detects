...
def main():
    # Modify for use
    train_path = './data/AFADF/AFADFR/content/data/AFADF/'
    db_name = 'afadsex'
    batch_size = 512
    nb_epochs = 10
    ...
    x_data = np.empty((80000, 64, 64, 3))
    y_data_g = np.empty((80000), dtype=int)
    ...
    hist = model.fit(data_generator_reg(X=x_train, Y=y_train_g, batch_size=batch_size),
