...
def main():
    ...
    if model_type == 1:
        ...
        weight_file = "./pretrained/fsanet_capsule.hd5"
        ...
        #weight_file = "synhead_noBIWI"+"_models/"+load_name+"/"+load_name+".h5"
        weight_file = "./pretrained/fsanet_var_capsule.hd5"
        ...
        #weight_file = "synhead_noBIWI"+"_models/"+load_name+"/"+load_name+".h5"
        weight_file = "./pretrained/fsanet_noS_capsule.hd5"
    ...
    hist = model.fit(data_generator_pose(X=x_train, Y=y_train, batch_size=batch_size),
